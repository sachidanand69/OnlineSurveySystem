...
public class AllQuetions extends javax.swing.JFrame {

    /**
     * Creates new form AllQuetions
     */
    public AllQuetions() {
        initComponents();
        try{
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(52, 130, 970, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllQuetions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AllQuetions().setVisible(true);
            }
        });
    }
